<template>
  <div>
    ...
    <ul class="list-inline">
      <li class="list-inline-item"><button @click="shownClass = 'artificer'" class="racebutton btn btn-primary">Artificer</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'barbarian'" class="racebutton btn btn-primary">Barbarian</button></li>
      <li class="list-inline-item"><button @click="shownClass ='bard'" class="racebutton btn btn-primary">Bard</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'cleric'" class="racebutton btn btn-primary">Cleric</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'druid'" class="racebutton btn btn-primary">Druid</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'factotum'" class="racebutton btn btn-primary">Factotum</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'fighter'" class="racebutton btn btn-primary">Fighter</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'monk'" class="racebutton btn btn-primary">Monk</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'paladin'" class="racebutton btn btn-primary">Paladin</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'ranger'" class="racebutton btn btn-primary">Ranger</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'rogue'" class="racebutton btn btn-primary">Rogue</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'sorcerer'" class="racebutton btn btn-primary">Sorcerer</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'warlock'" class="racebutton btn btn-primary">Warlock</button></li>
      <li class="list-inline-item"><button @click="shownClass = 'wizard'" class="racebutton btn btn-primary">Wizard</button></li>
    </ul>
    ...
    <div v-if="shownClass === 'factotum'">
      ...
      <table class="classtable table table-striped" id="factotumtable">
        ...
        <tbody>
          ...
          <tr>
            <td>4</td><td>2</td>
            <td>Ability Score Improvement</td><td>4</td><td>3</td><td>0</td><td>0</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>5</td><td>3</td>
            <td>Extra Attack</td><td>4</td><td>4</td><td>2</td><td>0</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>6</td><td>3</td>
            <td>Ability Score Improvement</td><td>4</td><td>4</td><td>2</td><td>0</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>7</td><td>3</td>
            <td>Factotum Philosophy Feature</td><td>4</td><td>4</td><td>3</td><td>0</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>8</td><td>3</td>
            <td>Ability Score Improvement</td><td>4</td><td>4</td><td>3</td><td>0</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>9</td><td>4</td>
            <td>-</td><td>4</td><td>4</td><td>3</td><td>2</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>10</td><td>4</td>
            <td>Factotum Philosophy Feature</td><td>5</td><td>4</td><td>3</td><td>2</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>11</td><td>4</td>
            <td>Inspired Defense</td><td>5</td><td>4</td><td>3</td><td>3</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>12</td><td>4</td>
            <td>Ability Score Improvement</td><td>5</td><td>4</td><td>3</td><td>3</td><td>0</td><td>0</td>
          </tr>
          <tr>
            <td>13</td><td>5</td>
            <td>-</td><td>5</td><td>4</td><td>3</td><td>3</td><td>1</td><td>0</td>
          </tr>
          <tr>
            <td>14</td><td>5</td>
      ...
      <ul>
        ...
        <li>
          <strong>Great Weapon Fighting</strong> - When you roll a 1 or 2 on a damage die for an attack you make with a melee weapon that you are wielding with two hands, you can reroll the die and must use the new roll, even if the new roll is a 1 or a 2. The weapon must have the two-handed or versatile property for you to gain this benefit.
        </li>
      </ul>
