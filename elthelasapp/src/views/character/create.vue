<template>
  <div>
    ...
    <ol>
      <li>Determine your base scores using a method determined by your GM.</li>
      <li>Apply player adjustments. To do this, add +2 to one score, and +1 to another score. These adjustments cannot be applied to the same score and cannot raise any score above 20.</li>
      <li>Distribute your 6 scores among the 6 abilities: Strength, Dexterity, Constitution, Intelligence, Wisdom, Charisma</li>
    </ol>
    <p>
      <strong>Point Buy Method.</strong> A point buy method allows players to build their own ability scores according to how they want their character to be good at. You start with an array of 6 8s. You then spend points to increase those numbers until you have no more points to spend. The cost of any number can be determined via the table below, and you can't increase any number over 16 using this method (before player adjustments). The amount of points you have to spend is determined by your GM, but common numbers include 25, 27, 30, or 33.
    </p>
    <p>
      <strong>Rolling Method.</strong> If your game prefers a more random assortment of abilities, instead of using the Point Buy Method you can use the Rolling method instead. To do so, roll 4d6 and drop the lowest result. Add the remaining dice together and you will end up with a number between 3 and 18. Do this until you have 6 such numbers.
    </p>
    <table class="table table-sm" style="width:50%">
      <thead><tr><td>Score</td><td>Cost</td></tr></thead>
      <tbody>
...
<style src="./scss/create.scss"></style>