  ...
  <div class="col-sm-12">
    <b-tabs id="refdiv">
      ...
      <b-tab index="1" title="Conditions">
        ...
        <ul>
          <li><strong>Levels of Exhaustion.</strong> This Condition is cumulative. Each time you receive it, you gain 1 level of exhaustion. You die if your exhaustion level exceeds 10.</li>
          ...
          <b-tab index='1' title="Acid">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>2</td><th>Fatal Wound</th><td>Either you suffer massive tissue damage, or major organs are part eaten away. Even if you succeed at the normal death saving throws, you remain unconscious and will die after 1d6 turns have passed, at the end of your turn, unless you are magically healed above 0 hit points, or stabilised with a DC 17 Wisdom (Medicine) check using a healer's kit. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>3</td><th>Paralysis</th><td>Spinal damage leaves you unable to move or feel anything from the waist down. You will need carrying or some sort of device to allow mobility (otherwise you can only crawl 5 feet per turn), and count as restrained. Still, there is always hope for a particularly strong person: at the beginning of every week, you can make a DC 20 Constitution saving throw – on a success, you miraculously recover. Otherwise, this flaw only ends if you receive powerful magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>4</td><th>Melted Arm</th><td>Your arm or hand is scorched off, pumping arterial blood and yellow ichor everywhere. Due to the flow of blood, you lose 1d6 hit points at the end of each of your turns, unless you receive magical healing to seal the stump, it is cauterised by fire or radiant damage, or another character uses an action to apply a tourniquet. Due to system shock, you must make a death saving throw immediately, with disadvantage on the roll. Following recovery, you can no longer hold anything with two hands, and can hold only a single object at a time. The distraction of the pain means that if you attempt to cast any spell you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. Finally, if the lost arm was your dominant arm (50% chance), unless you are trained in the Dual Wielder feat or the Two-Weapon Fighting Style, you suffer disadvantage with weapon attacks until you learn to use your off-hand. You learn to live with this pain and train your off-hand after a base recovery time of 40 days (see Recovery above). The limb can be restored by either Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>5</td><th>Melted Leg</th><td>Your leg or foot is scorched off, pumping arterial blood and yellow ichor everywhere. Due to the flow of blood, you lose 1d6 hit points at the end of each of your turns, unless you receive magical healing to seal the stump, it is cauterised by fire or radiant damage, or another character uses an action to apply a tourniquet. Due to system shock, you must make a death saving throw immediately, with disadvantage on the roll. Following recovery, your speed on foot is halved and you must use a cane or crutch to move, unless you receive a prosthesis of some kind. Additionally, you fall prone after using the dash action, and suffer disadvantage on Dexterity checks made to balance. Finally, distraction from the pain means that if you attempt to cast any spell you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. You learn to live with this pain after a base recovery time of 40 days (see Recovery above). The limb can be restored by either Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>6-8</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, “I'm... I'm Alright!” and any results which indicate death (like Fatal Wound or Instant Death). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9-10</td><th>Internal Bleeding</th><td>The attack leaves you with hidden damage, drawing you towards death. You lose 1d3 hit points at the end of every hour, even if stabilised. This injury is difficult to spot, but once diagnosed, This flaw can be removed by magic such as Heal, Regenerate or Wish, or if another character proficient in Medicine conducts surgery: this takes 1 hour, expends one use of a healer's kit and requires a successful DC 17 Wisdom (Medicine) check. The surgery itself inflicts 3d6 piercing damage. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>11-12</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>13-14</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>15-16</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>17-18</td><th>Ruined Eye</th><td>If you wear a helmet, you must make a DC 17 Dexterity saving throw – if you fail (or have no helmet), one of your eyes is destroyed. From now on, you suffer disadvantage on Wisdom (Perception) checks that rely on sight, and on ranged attack rolls. If a subsequent injury damages your other eye, you are permanently blinded. Magic such as Regenerate or Wish can restore the lost eye. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>19-20</td><th>Pelvic Injury</th><td>The attack destroys your nethers. Whenever you attempt a Strength (Athletics) check or take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw or lose 1d6 hit points. You also can't ride a horse without suffering 1d10 hit points. Finally, this injury renders you permanently infertile. This flaw ends after a base recovery time of 70 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish, although the infertility can only be reversed by Greater Restoration or Remove Curse. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>21-23</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by either Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>24-25</td><th>Hand Injury</th><td>The attack costs you several fingers. There is a 50% chance of the affected hand being your dominant hand. You can just about carry a shield, but if it's a weapon hand, your weapon attacks suffer a -2 penalty, unless you are trained in either the Dual Wielder feat or the Two-Weapon Fighting Style. Also, if it is your dominant hand, if you attempt to cast a spell with somatic components, you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. These penalties last a base recovery time of 40 days (see Recovery above). This flaw can be reversed by magic such as Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>26-28</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-30</td><th>Old Battle Wound</th><td>You more or less recover, but become plagued for years with recurring pains. After every long rest, you must succeed at a DC 11 Constitution saving throw or suffer -2 to your Dexterity and Wisdom scores until the next long rest. This penalty can be neutralised by special salves, prepared by a character proficient in Medicine or using a herbalism kit with which they are proficient. This flaw can be removed through magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>31-32</td><td>Useless Shield</td><td>Unless your shield is made of adamantine, the attack leaves it ruined and worthless. It provides no bonus to AC until it is repaired or subjected to a mending spell. If you don't have a shield, treat this result as Ruined Armour. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>33-36</td><th>Infected Wounds</th><td>The damage refuses to properly heal, and instead becomes swollen and leaks a noisome pus. Your hit point maximum is reduced by 1 for every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive the spell heal minor injury or, alternatively, someone can tend to the wound and make a DC 14 Wisdom (Medicine) check once every 24 hours. After ten successes, the wound heals. Characters who are immune to disease treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>37-38</td><th>Personality Change</th><td>In the aftermath of the attack, due to post-traumatic stress, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by magic such as Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>39-40</td><th>I'm Melting!</th><td>Unless you are immune to being frightened, you frantically stumble towards an ally, grasping at them, pleading for help and dripping acid, before passing out. You immediately move up to half your speed (rounded up) towards a random friendly creature and attempt a grapple; this movement can result in opportunity attacks. If the grapple succeeds, you also inflict 1d6 acid damage. At the beginning of your next turn, you fall unconscious, and begin making death saving throws as usual. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-42</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards dragons or sorcerers) or even the type of attack (such as a fear of acid). This flaw can be removed by magic such as Greater restoration or Wish.  You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43-46</td><th>Horrible Scar</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), you are disfigured to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic like Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>47-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index='2' title="Bludgeoning">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>3</td><th>Paralysis</th><td>Spinal damage leaves you unable to move or feel anything from the waist down. You will need carrying or some sort of device to allow mobility (otherwise you can only crawl 5 feet per turn), and count as restrained. Still, there is always hope for a particularly strong person: at the beginning of every week, you can make a DC 20 Constitution saving throw – on a success, you miraculously recover. Otherwise, this flaw only ends if you receive magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                ...
                <tr><td>6-8</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound or Instant Death). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9</td><th>I Can't Move!</th><td>Brain trauma leaves you fully paralysed, at least for a short time. You can do little more than speak, but can still cast spells that don't require somatic components. However, as you can't feel much of your body, you gain advantage on any Constitution saving throw to maintain concentration on spells due to receiving damage. After every long rest, the character can make a DC 14 Constitution saving throw to end the paralysis. This flaw can also be removed by magic such as Freedom of Movement, Greater Restoration, Heal Minor Injury, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>10</td><th>I Can't See!</th><td> If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then one too many blows to the head has damaged your brain in a strange and horrible way. You are temporarily blinded. This flaw ends when you receive magic such as Heal Minor Injury, Greater Restoration, Heal, Regenerate or Wish, or you succeed at a DC 14 Constitution saving throw, which you can make after every long rest. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>11-12</td><th>Internal Bleeding</th><td>The attack leaves you with hidden damage, drawing you towards death. You lose 1d3 hit points at the end of every hour, even if stabilised. This injury is difficult to spot, but once diagnosed, This flaw can be removed by magic such as Heal, Regenerate or Wish, or if another character proficient in Medicine conducts surgery: this takes 1 hour, expends one use of a healer's kit and requires a successful DC 17 Wisdom (Medicine) check. The surgery itself inflicts 3d6 piercing damage. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>13-14</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>15-16</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>17-18</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>19-20</td><th>Head Injury</th><td> If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then head trauma damages your mental facilities somehow, often leaving a bald patch at the scar. Roll 1d3: 1: you lose 1 point from your Intelligence score; 2: you lose 1 point from your Wisdom score; 3: you lose 1 point from your Charisma score. This flaw is often accompanied by speech or memory problems, requiring you to relearn basic skills and social niceties. If the same ability score is affected a second time or more in the future by this flaw, you must succeed at a DC 14 Constitution saving throw or also suffer the Coma flaw (see the Cold Damage page). This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>21-22</td><th>Multiple Fractures</th><td>You take a thorough beating, punctuated by the cracking of several bones. Roll 1d6 twice (rerolling duplicates), and you suffer both the relevant flaws: 1: Broken Arm; 2: Broken Jaw; 3: Broken Ribs; 4: Hand Injury; 5: Leg Wound; 6: Pelvic Injury. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>23-24</td><th>Broken Jaw</th><td>If you wear a helmet, you must make a DC 11 Dexterity or Constitution saving throw (your choice) – if you fail (or have no helmet), your jaw is smashed, scattering teeth everwhere. You find eating and speaking very painful, and suffer disadvantage on most Charisma checks. Additionally, if you attempt to cast a spell which uses verbal components, you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. This flaw ends after a base recovery time of 90 days (see Recovery above), or if you receive magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>25-26</td><th>Broken Arm</th><td>As the attack slams home, an audible 'crack' renders an arm close to useless for a time. There is a 50% chance that the broken arm is your dominant arm and if so, unless you are trained in the Dual Wielder feat or the Two-Weapon Fighting Style, you suffer disadvantage with weapon attacks. If it is your other arm, you cannot wear a shield. This flaw ends after a base recovery time of 30 weeks (see Recovery above), or if you receive magic such as a Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>27-28</td><th>Deafened</th><td>If you wear a helmet, you must make a DC 14 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, you are deafened. This flaw is removed if you receive magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-30</td><th>Pelvic Injury</th><td>Either your pelvis is struck a crippling blow, or the attack destroys your nethers. Whenever you attempt a Strength (Athletics) check or take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw or lose 1d6 hit points. You also can't ride a horse without suffering 1d10 hit points. Finally, this injury renders you permanently infertile. This flaw ends after a base recovery time of 70 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish, although the infertility can only be reversed by Greater Restoration or Remove Curse. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>31-32</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>33-34</td><th>Broken Ribs</th><td>Your rib cage is partly caved in. Whenever you attempt a Strength (Athletics) check or attempt to take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw. If you fail the save, you lose your action and can't use reactions until the start of your next turn. This flaw ends after a base recovery time of 50 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-36</td><th>Punch Drunk</th><td> If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then due to hearing impairment or brain trauma, your coordination is often disrupted. After every short or long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or suffer disadvantage on Dexterity (Acrobatics) checks. This penalty lasts until the next short or long rest. Additionally, if you are knocked prone, it costs you double the standard movement to stand up. This flaw can be removed through magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>37-38</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>39-40</td><td>Useless Shield</td><td>Unless your shield is made of adamantine, the attack leaves it ruined and worthless. It provides no bonus to AC until it is repaired or subjected to a mending spell. If you don't have a shield, treat this result as Ruined Armour. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-42</td><th>Personality Change</th><td>In the aftermath of the attack, either as a result of head injury or due to post-traumatic stress, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by magic such as Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43</td><th>Fastball Special</th><td>The force of the attack sends you haplessly flying through the air towards another unsuspecting creature. You are pushed up to 10 feet towards a random creature and, if in range to strike it, knock it prone, unless that other creature succeeds at a DC 11 Dexterity or Strength saving throw (creature's choice). This roll is made with disadvantage if you are bigger than the dodging creature. If you are huge or gargantuan, you are too heavy to be thrown, and this result has no effect. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>44-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
                <tr><td>99+</td><th>I'm... I'm Alright!</th><td>The gods must be smiling today – the blow seemed worse than it actually is, and you are assumed dead. Rather than making any death saving throws, you are instead stabilised and returned to 1 hit point and, at the beginning of your next turn, regain 1d10 hit points and can act as normal, gaining advantage on your first attack that turn.</td></tr>
              </tbody>
            </table>
          </b-tab>
          <b-tab index='3' title="Cold">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>4</td><th>Coma</th><td>You enter a death-like sleep from which nothing can seemingly awaken you, though dim life signs still remain. You remain unconscious, even after being stabilised. Following a long rest, make a death saving throw. Three failed saves result in death (possibly due to lack of fluids, amongst other complications), but a result of 15 or means the coma ends. If and when you awaken, you suffer three levels of exhaustion (these exhaustion levels can be removed normally). The coma can also be ended prematurely by magic such as Dream, Remove Curse, Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>5</td><th>Destroyed Arm</th><td>Your arm or hand is frozen solid and then shattered, leaving only a numb, blackened stump. Due to system shock, you must make a death saving throw immediately, with disadvantage on the roll. Following recovery, you can no longer hold anything with two hands, and can hold only a single object at a time. Additionally, if the lost arm was your dominant arm (50% chance), unless you are trained in the Dual Wielder feat or the Two-Weapon Fighting Style, you suffer disadvantage with weapon attacks until you learn to use your off-hand. You learn to train your off-hand after a base recovery time of 40 days (see Recovery above). The limb can be restored by either Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>6</td><th>Destroyed Leg</th><td>Your leg or foot is frozen solid and then shattered, leaving only a numb, blackened stump. Due to system shock, you must make a death saving throw immediately, with disadvantage on the roll. Following recovery, your speed on foot is halved and you must use a cane or crutch to move, unless you receive a prosthesis of some kind. Additionally, you fall prone after using the dash action, and suffer disadvantage on Dexterity checks made to balance. The limb can be restored by either Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>7-9</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound, Instant Death or worse). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>10-11</td><th>Lung Trauma</th><td>Your lungs are withered, placing you dangerously close to death. While this flaw remains, you can only stabilise naturally after five death saving throws, rather than three. Following recovery, even routine activity leaves you breathless, and you are wracked with coughing fits when the air is thin or smoky. For every four hours spent walking (or eight hours riding), and when reduced to half your maximum hit points or less, you must succeed at a DC 11 Constitution saving throw or suffer one level of exhaustion. Exhaustion levels gained from this flaw are lost during a short or long rest, or can be removed by a character equipped with a herbalism kit with which they are proficient. Finally, this flaw ends if you succeed at a DC 17 Constitution saving throw rolled at the beginning of every month, or if removed by Heal, Greater Restoration, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>12-13</td><th>Severe Hypothermia</th><td> Reduced core body heat leaves you with pale puffy skin, blue extremities and lips, and confusion. Your speed is halved (rounded up) and, in combat, you count as if you are subject to the confusion spell (although you cannot make Wisdom saving throws to end the effect as in the standard spell). This flaw ends if you succeed at a DC 11 Constitution saving throw rolled after a long rest, or you receive magic such as Greater Restoration, Protection from Energy (cold) or Wish. At the Dungeon Master's discretion, sources of intense heat may allow you to make an additional saving throw. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>14-15</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>16-17</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>18-19</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>20-22</td><th>Crippling Fatigue</th><td>You can never shake your sense of tiredness, and gain one level of exhaustion. This can be removed normally. However, following every long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or gain a level of exhaustion. If you fail this saving throw by 5 or more, you gain two levels. Accumulating enough exhaustion levels can lead to your death. However, if you roll an unmodified 20, this flaw ends, and can also be ended by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>23-25</td><th>Frost Bite</th><td> Some of your digits rot away, leaving painful blackened stumps. Roll 1d3: 1: you lose 1d3 toes; 2: you lose 1d3 fingers; 3: you lose 1d3 fingers and 1d3 toes. If you lose toes, your foot speed is reduced by 5 feet. If you lose fingers, there is a 50% chance of the affected hand being your dominant hand. You can just about carry a shield, but if it's a weapon hand, your weapon attacks suffer a -2 penalty, unless you are trained in either the Dual Wielder feat or the Two-Weapon Fighting Style. Also, if it is your dominant hand, if you attempt to cast a spell with somatic components, you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. These penalties last a base recovery time of 40 days (see Recovery above). This flaw can be removed by magic such as Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>26-28</td><th>Deep Freeze</th><td>Shaking violently with the cold, your strength is sapped for days. While affected by this flaw, you only recover a quarter of your hit dice (rounded up) during a long rest. After a long rest, you can make a DC 17 Constitution saving throw (with advantage if resistant to cold damage): on a success, this flaw ends – otherwise, it remains until you succeed on a future roll, or until you are the subject of magic such as Heal, Greater Restoration, Protection from Energy (cold) or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-30</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>31-37</td><td>Useless Shield</td><td>Unless your shield is made of adamantine, the attack leaves it ruined and worthless. It provides no bonus to AC until it is repaired or subjected to a mending spell. If you don't have a shield, treat this result as Ruined Armour. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>38-39</td><th>Wave of Ice</th><td>A freak burst of elemental ice blossoms where you fall. All other creatures within 10-foot range of you must succeed on a DC 11 Constitution saving throw, or suffer 2d6 cold damage. Additionally, this 10 feet radius of floor is frozen for up to one minute, counting as difficult terrain. A creature attempting to move across this area before it thaws must succeed on a DC 11 Dexterity saving throw or fall prone. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>40-41</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards dragons or sorcerers) or even the type of attack (such as a fear of snow). This flaw can be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>42-43</td><th>Horrible Scar</th><td> If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), you are disfigured to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic like Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>44-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index='4' title="Fire">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>6-8</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound, Instant Death or worse). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9-10</td><th>Lung Trauma</th><td>Your lungs are scorched or withered, placing you dangerously close to death. While this flaw remains, you can only stabilise naturally after five death saving throws, rather than three. Following recovery, even routine activity leaves you breathless, and you are wracked with coughing fits when the air is thin or smoky. For every four hours spent walking (or eight hours riding), and when reduced to half your maximum hit points or less, you must succeed at a DC 11 Constitution saving throw or suffer one level of exhaustion. Exhaustion levels gained from this flaw are lost during a short or long rest, or can be removed by a character equipped with a herbalism kit with which they are proficient. Finally, this flaw ends if you succeed at a DC 17 Constitution saving throw rolled at the beginning of every month, or if removed by Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>11-12</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>13-14</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>15-16</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>17-18</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by either Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>19-21</td><th>Hand Injury</th><td>The attack costs you several fingers. There is a 50% chance of the affected hand being your dominant hand. You can just about carry a shield, but if it's a weapon hand, your weapon attacks suffer a -2 penalty, unless you are trained in either the Dual Wielder feat or the Two-Weapon Fighting Style. Also, if it is your dominant hand, if you attempt to cast a spell with somatic components, you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. These penalties last a base recovery time of 40 days (see Recovery above). This flaw can be removed by magic such as Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>22-23</td><th>Troubled Sleep</th><td>Unless you are immune to being frightened, you suffer the following flaw: though you more or less recover, your sleep or trance is ravaged by inescapable nightmares, and rarely affords much rest. You must succeed on a DC 11 Charisma or Wisdom saving throw (your choice) after every long rest, or only recover a quarter of your hit dice. If you beat the save DC by 10 or more, the flaw ends. It can also be removed by magic such as Dream, Greater Restoration, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>24-26</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>27-30</td><td>Useless Shield</td><td>Unless your shield is made of adamantine, the attack leaves it ruined and worthless. It provides no bonus to AC until it is repaired or subjected to a mending spell. If you don't have a shield, treat this result as Ruined Armour. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>31-33</td><th>Infected Wounds</th><td>The damage refuses to properly heal, and instead becomes swollen and leaks a noisome pus. Your hit point maximum is reduced by 1 for every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive the spell Heal Minor Injury or, alternatively, someone can tend to the wound and make a DC 14 Wisdom (Medicine) check once every 24 hours. After ten successes, the wound heals. Characters who are immune to disease treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>34-35</td><th>Personality Change</th><td>In the aftermath of the attack, due to post-traumatic stress, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by magic such as Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>36-37</td><th>Aaaaaaarghhhhh!</th><td>Unless you are immune to being frightened, you panic as the flames consume you, slamming bodily into a creature that interrupts your maddened flight. You immediately move up to half your speed (rounded up) towards a random creature and attempt a shove (either to knock prone or push, your choice); this movement can result in opportunity attacks. If the shove succeeds, you also inflict 1d6 fire damage. Following this attack, you then fall unconscious, and begin making death saving throws as usual. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>38-40</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards dragons or sorcerers) or even the type of attack (such as a fear of fire). This flaw can be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-43</td><th>Horrible Scar</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), you are disfigured to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic like Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>44-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index='5' title="Force">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>7-9</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound, Instant Death or worse). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>10-11</td><th>Internal Bleeding.</th><td>The attack leaves you with hidden damage, drawing you towards death. You lose 1d3 hit points at the end of every hour, even if stabilised. This injury is difficult to spot, but once diagnosed, This flaw can be removed by magic such as Heal, Regenerate or Wish, or if another character proficient in Medicine conducts surgery: this takes 1 hour, expends one use of a healer's kit and requires a successful DC 17 Wisdom (Medicine) check. The surgery itself inflicts 3d6 piercing damage. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>12-13</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>14-15</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>16-18</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>19-20</td><th>Head Injury</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), ten head trauma damages your mental facilities somehow, often leaving a bald patch at the scar. Roll 1d3: 1: you lose 1 point from your Intelligence score; 2: you lose 1 point from your Wisdom score; 3: you lose 1 point from your Charisma score. This flaw is often accompanied by speech or memory problems, requiring you to relearn basic skills and social niceties. If the same ability score is affected a second time or more in the future by this flaw, you must succeed at a DC 14 Constitution saving throw or also suffer the Coma flaw. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>21-23</td><th>Broken Arm</th><td>As the attack slams home, an audible 'crack' renders an arm close to useless for a time. There is a 50% chance that the broken arm is your dominant arm and if so, unless you are trained in the Dual Wielder feat or the Two-Weapon Fighting Style, you suffer disadvantage with weapon attacks. If it is your other arm, you cannot wear a shield. This flaw ends after a base recovery time of 30 weeks (see Recovery above), or if you receive magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>24-26</td><th>Deafened</th><td>If you wear a helmet, you must make a DC 14 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, the attack leaves you deafened. This flaw is removed if you receive magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>27-28</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by either Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-31</td><th>Broken Ribs</th><td>Your rib cage is partly caved in. Whenever you attempt a Strength (Athletics) check or attempt to take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw. If you fail the save, you lose your action and can't use reactions until the start of your next turn. This flaw ends after a base recovery time of 50 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>32-34</td><th>Punch Drunk</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then due to hearing impairment or brain trauma, your coordination is often disrupted. After every short or long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or suffer disadvantage on Dexterity (Acrobatics) checks. This penalty lasts until the next short or long rest. Additionally, if you are knocked prone, it costs you double the standard movement to stand up. This flaw can be removed through magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-37</td><th>Shell-Shock</th><td>Either due to brain damage or a lifetime of facing horrors and death, you are somewhat indecisive and slow to react. You suffer a penalty of -2 to your Initiative. This flaw can be removed through magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>38-39</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>40</td><th>Force Magnet</th><td>Somehow, the magic of the attack embeds itself into your being and begins to attract other force energy towards you. From now on, whenever magic missile is cast by any spellcaster (including you!) and you are within its range, an extra missile flies off and strikes you, for normal damage. This flaw can only be removed by magic such as Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-42</td><th>Personality Change</th><td>In the aftermath of the attack, either as a result of head injury or due to post-traumatic stress, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by magic such as Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43-44</td><th>Fastball Special</th><td>The force of the attack sends you haplessly flying through the air towards another unsuspecting creature. You are pushed up to 10 feet towards a random creature and, if in range to strike it, knock it prone, unless that other creature succeeds at a DC 11 Dexterity or Strength saving throw (creature's choice). This roll is made with disadvantage if you are bigger than the dodging creature. If you are huge or gargantuan, you are too heavy to be thrown, and this result has no effect. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>45-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index='6' title="Lightning">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>7-9</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound, Instant Death or worse). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>10-11</td><th>Lung Trauma</th><td>Your lungs are scorched or withered, placing you dangerously close to death. While this flaw remains, you can only stabilise naturally after five death saving throws, rather than three. Following recovery, even routine activity leaves you breathless, and you are wracked with coughing fits when the air is thin or smoky. For every four hours spent walking (or eight hours riding), and when reduced to half your maximum hit points or less, you must succeed at a DC 11 Constitution saving throw or suffer one level of exhaustion. Exhaustion levels gained from this flaw are lost during a short or long rest, or can be removed by a character equipped with a herbalism kit with which they are proficient. Finally, this flaw ends if you succeed at a DC 17 Constitution saving throw rolled at the beginning of every month, or if removed by Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>12-13</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>14-15</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>16-17</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>18-19</td><th>Brain Damage</th><td>The attack damages your mental facilities somehow. Roll 1d3: 1: you lose 1 point from your Intelligence score; 2: you lose 1 point from your Wisdom score; 3: you lose 1 point from your Charisma score. This flaw is often accompanied by speech or memory problems, requiring you to relearn basic skills and social niceties. If the same ability score is affected a second time or more in the future by this flaw, you must succeed at a DC 14 Constitution saving throw or also suffer the Coma flaw. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>20-22</td><th>Blasted Eye</th><td>One of your eyes is destroyed by the burst of electricity. From now on, you suffer disadvantage on Wisdom (Perception) checks that rely on sight, and on ranged attack rolls. If a subsequent injury damages your other eye, you are permanently blinded. Magic such as Regenerate or Wish can restore the lost eye. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>23-25</td><th>Deafened</th><td>If you wear a helmet, you must make a DC 14 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, the attack leaves you deafened. This flaw is removed if you receive magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>26-28</td><th>Pelvic Injury</th><td>Either your pelvis is struck a crippling blow, or the attack destroys your nethers. Whenever yo attempt a Strength (Athletics) check or take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw or lose 1d6 hit points. You also can't ride a horse without suffering 1d10 hit points. Finally, this injury renders you permanently infertile. This flaw ends after a base recovery time of 70 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish, although the infertility can only be reversed by Greater Restoration or Remove Curse. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-31</td><th>Punch Drunk</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then due to hearing impairment or brain trauma, your coordination is often disrupted. After every short or long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or suffer disadvantage on Dexterity (Acrobatics) checks. This penalty lasts until the next short or long rest. Additionally, if you are knocked prone, it costs you double the standard movement to stand up. This flaw can be removed through magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>32-34</td><th>Shell-Shock</th><td>Either due to brain damage or a lifetime of facing horrors and death, you are somewhat indecisive and slow to react. You suffer a penalty of -2 to your Initiative. This flaw can be removed through magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-37</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>38-39</td><th>Chain Discharge</th><td>The electricity crackles over you for a moment and then, as you silently collapse, arcs out towards others nearby. All other creatures within 10-foot range of you must succeed on a DC 11 Dexterity saving throw or suffer 2d6 lightning damage. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>40-41</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards dragons or sorcerers) or even the type of attack (such as a fear of storms). This flaw can be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>42-43</td><th>Hideous Scar</th><td>You are scorched to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic such as Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>44-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index='7' title="Necrotic">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>8-9</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound, Instant Death or worse). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>10-11</td><th>Lung Trauma</th><td>Your lungs are scorched or withered, placing you dangerously close to death. While this flaw remains, you can only stabilise naturally after five death saving throws, rather than three. Following recovery, even routine activity leaves you breathless, and you are wracked with coughing fits when the air is thin or smoky. For every four hours spent walking (or eight hours riding), and when reduced to half your maximum hit points or less, you must succeed at a DC 11 Constitution saving throw or suffer one level of exhaustion. Exhaustion levels gained from this flaw are lost during a short or long rest, or can be removed by a character equipped with a herbalism kit with which they are proficient. Finally, this flaw ends if you succeed at a DC 17 Constitution saving throw rolled at the beginning of every month, or if removed by Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>12-13</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>14-15</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>16-17</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>18-19</td><th>Ruined Eye</th><td>If you wear a helmet, you must make a DC 17 Dexterity saving throw – if you fail (or have no helmet), one of your eyes is destroyed. From now on, you suffer disadvantage on Wisdom (Perception) checks that rely on sight, and on ranged attack rolls. If a subsequent injury damages your other eye, you are permanently blinded. Magic such as Regenerate or Wish can restore the lost eye. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>20-22</td><th>Pelvic Injury</th><td>Either your pelvis is struck a crippling blow, or the attack destroys your nethers. Whenever you attempt a Strength (Athletics) check or take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw or lose 1d6 hit points. You also can't ride a horse without suffering 1d10 hit points. Finally, this injury renders you permanently infertile. This flaw ends after a base recovery time of 70 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish, although the infertility can only be removed by Greater Restoration or Remove Curse. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>23-24</td><th>Agonizing Wound</th><td>The injury plagues you with flashes of searing pain from time to time. Whenever you attempt a Strength (Athletics) check or attempt to take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw. If you fail the save, you lose your action and can't use reactions until the start of your next turn. This flaw ends after a base recovery time of 70 days (see Recovery above), and is also removed by magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>25-27</td><th>Crippling Fatigue</th><td>You can never shake your sense of tiredness, and gain one level of exhaustion. This can be removed normally. However, following every long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or gain a level of exhaustion. If you fail this saving throw by 5 or more, you gain two levels. Accumulating enough exhaustion levels can lead to your death. However, if you roll an unmodified 20, this flaw ends, and can also be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>28-31</td><th>Stolen Life</th><td>Unless you are immune to magical ageing, you physically age by 1d6 years, and are rendered infertile. For every year you age, you suffer an additional 1d4 necrotic damage: this damage may lead to instant death. If this flaw is inflicted by a creature (or a spell cast by one), then that creature gains temporary hit points equal to the additional necrotic damage inflicted. The infertility can only be reversed by magic such as either Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>32-34</td><th>Troubled Sleep</th><td>Unless you are immune to being frightened, you suffer the following flaw: though you more or less recover, your sleep or trance is ravaged by inescapable nightmares, and rarely affords much rest. You must succeed on a DC 11 Charisma or Wisdom saving throw (your choice) after every long rest, or only recover a quarter of your hit dice. If you beat the save DC by 10 or more, the flaw ends. It can also be removed by magic such as Dream, Greater Restoration, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-38</td><th>Infected Wounds</th><td>The damage refuses to properly heal, and instead becomes swollen and leaks a noisome pus. Your hit point maximum is reduced by 1 for every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive the spell Heal Minor Injury or, alternatively, someone can tend to the wound and make a DC 14 Wisdom (Medicine) check once every 24 hours. After ten successes, the wound heals. Characters who are immune to disease treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>39-40</td><th>Personality Change</th><td>In the aftermath of the attack, due to post-traumatic stress, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by magic such as Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-42</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards undead or sorcerers) or even the type of attack (such as a fear of germs). This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43-44</td><th>Horrible Scar</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), you are disfigured to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic like Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>45-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index="8" title="Piercing">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>5-8</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound or Instant Death). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9-10</td><th>Punctured Lung</th><td>Your lungs are pierced and part collapsed, placing you dangerously close to death. While this flaw remains, you can only stabilise naturally after five death saving throws, rather than three. Following recovery, even routine activity leaves you breathless, and you are wracked with coughing fits when the air is thin or smoky. For every four hours spent walking (or eight hours riding), and when reduced to half your maximum hit points or less, you must succeed at a DC 11 Constitution saving throw or suffer one level of exhaustion. Exhaustion levels gained from this flaw are lost during a short or long rest, or can be removed by a character equipped with a herbalism kit with which they are proficient. Finally, this flaw ends if you succeed at a DC 17 Constitution saving throw rolled at the beginning of every month, or if removed by Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>11-12</td><th>Internal Bleeding</th><td>The attack leaves you with hidden damage, drawing you towards death. You lose 1d3 hit points at the end of every hour, even if stabilised. This injury is difficult to spot, but once diagnosed, This flaw can be removed by magic such as Heal, Regenerate or Wish, or if another character proficient in Medicine conducts surgery: this takes 1 hour, expends one use of a healer's kit and requires a successful DC 17 Wisdom (Medicine) check. The surgery itself inflicts 3d6 piercing damage. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>13-14</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>15-16</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>17-18</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>19-20</td><th>Gouged Eye</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), one of your eyes is pierced, either by the foe's weapon or the dent in your helm. From now on, you suffer disadvantage on Wisdom (Perception) checks that rely on sight, and on ranged attack rolls. If a subsequent injury damages your other eye, you are permanently blinded. Magic such as Regenerate or Wish can restore the lost eye. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>21-22</td><th>Pelvic Injury</th><td>Either your pelvis is struck a crippling blow, or the attack destroys your nethers. Whenever you attempt a Strength (Athletics) check or take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw or lose 1d6 hit points. You also can't ride a horse without suffering 1d10 hit points. Finally, this injury renders you permanently infertile. This flaw ends after a base recovery time of 70 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish, although the infertility can only be reversed by Greater Restoration or Remove Curse. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>23-24</td><th>Agonizing Wound</th><td>The injury plagues you with flashes of searing pain from time to time. Whenever you attempt a Strength (Athletics) check or attempt to takes any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw. If you fail the save, you lose your action and can't use reactions until the start of your next turn. This flaw ends after a base recovery time of 70 days (see Recovery above), and is also removed by magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>25-26</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by either Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>27-28</td><th>Shell-Shock</th><td> Either due to brain damage or a lifetime of facing horrors and death, you are somewhat indecisive and slow to react. You suffer a penalty of -2 to your Initiative. This flaw can be removed through magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-30</td><th>Hand Injury</th><td>The attack costs you several fingers. There is a 50% chance of the affected hand being your dominant hand. You can just about carry a shield, but if it's a weapon hand, your weapon attacks suffer a -2 penalty, unless you are trained in either the Dual Wielder feat or the Two-Weapon Fighting Style. Also, if it is your dominant hand, if you attempt to cast a spell with somatic components, you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. These penalties last a base recovery time of 40 days (see Recovery above). This flaw can be removed by magic such as Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>31-32</td><th>Bleeding Wound</th><td>Frustratingly, the latest injury is loathe to stop bleeding. When you roll for initiative at the start of combat, on the result of an odd number, the wound re-opens: they suffer 1 hit point at the end of each of your turns, unless a character uses an action to bind the wound. This flaw ends if you receive magical healing, or if you succeed at a DC 17 Constitution saving throw after a long rest: if they fail this save the first time, they gain a +5 bonus in future. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>33-34</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-36</td><th>Old Battle Wound</th><td>You more or less recover, but become plagued for years with recurring pains. After every long rest, you must succeed at a DC 11 Constitution saving throw or suffer -2 to your Dexterity and Wisdom scores until the next long rest. This penalty can be neutralised by special salves, prepared by a character proficient in Medicine or using a herbalism kit with which they are proficient. This flaw can be removed through magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>37-38</td><th>Infected Wound</th><td>The damage refuses to properly heal, and instead becomes swollen and leaks a noisome pus. Your hit point maximum is reduced by 1 for every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive the spell Heal Minor Injury or, alternatively, someone can tend to the wound and make a DC 14 Wisdom (Medicine) check once every 24 hours. After ten successes, the wound heals. Characters who are immune to disease treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>39-40</td><th>Shish Kebab</th><td>The attacker impales you, and the force of the blow drives the protruding tip towards another creature, too. Another creature of the attacker's choice within 5 feet (or within 10 feet, if the attacker is huge or gargantuan) is also targeted, and the attacker makes another attack roll for free. This second target does not need to be within normal attacking range for the attacker, but they will gain the benefit of cover from the impaled character! If you are huge or gargantuan, you are too heavy to be moved, and this result has no effect. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-42</td><th>Horrible Scar</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), you are disfigured to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic like Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index="9" title="Poison">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>6</td><th>Anaphylactic Shock</th><td>Your body reacts dramatically to the venom. Following recovery, you suffer disadvantage on saves against the effects of this specific venom. If you do become affected by this venom, as well as any other effects, you must succeed at a DC 14 Constitution saving throw or be immediately reduced to 0 hit points, and will die after 1d6 turns have passed, at the end of your turn, unless the poison is neutralised, or you are stabilised by another character succeeding at a DC 14 Wisdom (Medicine) check. This result overrides any existing resistance you may have to that venom. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>7-8</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Poisoning or Instant Death). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9-10</td><th>Destroyed Eyes</th><td>The virulent toxin destroys your eyes. From now on, you are permanently blinded, unless you are cured by magic such Greater Restoration, Heal, Regenerate or Wish. Perhaps you'll learn to adapt? You also gain 1 level of exhaustion.</td></tr>
                <tr><td>11-12</td><th>Lung Trauma</th><td> Your lungs are scorched or withered, placing you dangerously close to death. Until you are stabilised, you must make two death saving throws a turn. Following recovery, even routine activity leaves you breathless, and you are wracked with coughing fits when the air is thin or smoky. For every four hours spent walking (or eight hours riding), and when reduced to half your maximum hit points or less, you must succeed at a DC 11 Constitution saving throw or suffer one level of exhaustion. Exhaustion levels gained from this flaw are lost during a short or long rest, or can be removed by a character equipped with a herbalism kit with which they are proficient. Finally, this flaw ends if you succeed at a DC 17 Constitution saving throw rolled at the beginning of every month, or if removed by magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>13-15</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>16-18</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>19-21</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>22-24</td><th>Impaired Mind</th><td>Unless you are immune to poison, the venom permanently damages your mental facilities somehow. Roll 1d3: 1: you lose 1 point from your Intelligence score; 2: you lose 1 point from your Wisdom score; 3: you lose 1 point from your Charisma score. This flaw is often accompanied by speech or memory problems, requiring you to relearn basic skills and social niceties. If the same ability score is affected a second time or more in the future by this flaw, you must succeed at a DC 14 Constitution saving throw or also suffer the Coma flaw. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>25-28</td><th>Pelvic Injury</th><td>Either your pelvis is struck a crippling blow, or the attack destroys your nethers. Whenever you attempt a Strength (Athletics) check or take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw or lose 1d6 hit points. You also can't ride a horse without suffering 1d10 hit points. Finally, this injury renders you permanently infertile. This flaw ends after a base recovery time of 70 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish, although the infertility can only be reversed by Greater Restoration or Remove Curse. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-31</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>32-35</td><th>Liver Failure</th><td>The poison was almost too much you, and from now on you suffer vulnerability to all poison damage, and can no longer tolerate other toxins, such as alcohol. No more tavern crawls for you! This flaw overrides any existing resistance you may have to poison, and can only be removed by magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>36-39</td><th>Crippling Fatigue</th><td>You can never shake your sense of tiredness, and gain one level of exhaustion. This can be removed normally. However, following every long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or gain a level of exhaustion. If you fail this saving throw by 5 or more, you gain two levels. Accumulating enough exhaustion levels can lead to your death. However, if you roll an unmodified 20, this flaw ends, and can also be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>40-41</td><th>Personality Change</th><td>In the aftermath of the attack, due to post-traumatic stress, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>42-43</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards spiders or sorcerers) or even the type of attack (such as a fear of wine). This flaw can be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>44-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index="10" title="Psychic">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>2</td><th>Shredded Psyche</th><td>You convulse with agony, and your shredded mind refuses to let normal bodily processes continue. Even if you succeed at the normal death saving throws, you remain unconscious and will die after 1d6 turns have passed, at the end of your turn, unless you are magically healed above 0 hit points. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>3</td><th>Coma</th><td>You enter a death-like sleep from which nothing can seemingly awaken you, though dim life signs still remain. You remain unconscious, even after being stabilised. Following a long rest, make a death saving throw. Three failed saves result in death (possibly due to lack of fluids, amongst other complications), but a result of 15 or means the coma ends. If and when you awaken, you suffer three levels of exhaustion (these exhaustion levels can be removed normally). The coma can also be ended prematurely by magic such as Dream, Greater Restoration, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>4</td><th>Screaming Horror</th><td>Unless you are immune to being frightened, your mind is broken beyond redemption, and you spend your days alternating between empty-eyed stares and bouts of horrified screaming – death would be a kinder fate. You are almost entirely useless, though you can be persuaded to stumble along meekly when feeling more placid – however, there is a 50% chance (checked for after each short or long rest) that you will scream uncontrollably, unless drugged, knocked out or subject to a calm emotions spell. This flaw can only be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>5-6</td><th>I Can't Move!</th><td>Brain trauma leaves you fully paralysed, at least for a short time. You can do little more than speak, but can still cast spells that don't require somatic components. However, as you can't feel much of your body, you gain advantage on any Constitution saving throw to maintain concentration on spells due to receiving damage. After every long rest, the character can make a DC 17 Constitution saving throw to end the paralysis. This flaw can also be removed by magic such as Freedom of Movement, Greater Restoration, Heal Minor Injury, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>7-8</td><th>Horrors in the Dark</th><td>Your scrambled brain plays tricks on you, leaving your vision a deep blackness peopled by fleeting spirits and phantasms. You are temporarily blinded. This flaw ends when you receive magic such as Dream, Greater Restoration, Heal Minor Injury, Remove Curse or Wish, or you succeed on a DC 14 Intelligence saving throw, which you can make after every long rest. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9-11</td><th>Brain Damage</th><td>The attack damages your mental facilities somehow. Roll 1d3: 1: you lose 1 point from your Intelligence score; 2: you lose 1 point from your Wisdom score; 3: you lose 1 point from your Charisma score. This flaw is often accompanied by speech or memory problems, requiring you to relearn basic skills and social niceties. If the same ability score is affected a second time or more in the future by this flaw, you must succeed at a DC 14 Constitution saving throw or also suffer the Coma flaw. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>12-14</td><th>Recurring Possession</th><td>Even if the attacker is eventually destroyed, a fragment of its spirit burrows itself deep within your psyche, making you commit horrors when you suspect yourself safe. Every time you take a long rest, you must succeed at a DC 11 Charisma saving throw or be possessed by the attacking creature (or its spirit) for up to 1d10 minutes, in a manner similar to the dominate spell. As with the spell, you can repeat your saving throw if you suffer damage. When the possession ends, you have no memory of what you have done. This possession can typically be noticed by a change in your mannerisms when possessed, and also by a detect magic spell at any time. This flaw can only be removed by magic such as Greater Restoration, Remove Curse or Wish, or possibly by destroying or confronting the possessing spirit, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>15-18</td><th>Debilitating Migraines</th><td>The attack permanently damaged your brain, and you become plagued with nosebleeds and nauseating headaches. These come most frequently in times of stress, or following loud noise. When rolling for initiative at the start of combat, or when you suffer thunder damage, you must make a DC 11 Constitution saving throw. If you fail the save, the migraines come again: you suffer disadvantage on future initiative and Wisdom (Perception) checks. The migraine attack ends when you take a short or long rest. This flaw can only be removed by magic such as Greater Restoration, Heal, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>19-21</td><th>Crippling Fatigue</th><td>You can never shake your sense of tiredness, and gain one level of exhaustion. This can be removed normally. However, following every long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or gain a level of exhaustion. If you fail this saving throw by 5 or more, you gain two levels. Accumulating enough exhaustion levels can lead to your death. However, if you roll an unmodified 20, this flaw ends, and can also be ended by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>22-24</td><th>Partially Deafened</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, the attack leaves your hearing permanently muffled. You suffer disadvantage on Wisdom (Perception) checks that rely on hearing. This flaw can be reversed through magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>25-29</td><th>Shell-Shock</th><td>Either due to brain damage or a lifetime of facing horrors and death, you are somewhat indecisive and slow to react. You suffer a penalty of -2 to your Initiative. This flaw can be removed through magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>30-34</td><th>Troubled Sleep</th><td>Unless you are immune to being frightened, you suffer the following flaw: though you more or less recover, your sleep or trance is ravaged by inescapable nightmares, and rarely affords much rest. You must succeed on a DC 11 Charisma or Wisdom saving throw (your choice) after every long rest, or only recover a quarter of your hit dice. If you beat the save DC by 10 or more, the flaw ends. It can also be removed by magic such as Dream, Greater Restoration, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-37</td><th>Pushed to the Brink</th><td>Unless you are immune to being frightened, your mind is rendered brittle. You become over-emotional and prone to regular fits of crying, suffer disadvantage on checks or saving throws related to avoiding being frightened, and may react strongly to certain enchantment spells (at the Dungeon Master's discretion). This ends when you make a successful DC 17 Charisma or Wisdom saving throw (your choice) rolled at the beginning of each month – this saving throw can also be made if you are subject to a Calm Emotions spell. The flaw can also be removed by magic such as Greater Restoration, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>38-42</td><th>Personality Change</th><td>In the aftermath of the attack, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by magic such as Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43-45</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards mind flayers or sorcerers) or even the type of attack (such as a fear of magic). This flaw can be removed bymagci such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>46-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index="11" title="Radiant">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>5-8</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound or Instant Death). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9-11</td><th>Burnt-Out Eyes</th><td>If you wear a helmet, you must make a DC 17 Dexterity saving throw – if you fail (or have no helmet), then the intense light gives you one last glimpse of beauty, before it takes your sight forever. From now on, you are permanently blinded – unless you are cured by magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>12-13</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>14-15</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>16-17</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>18-20</td><th>Ruined Eye</th><td>If you wear a helmet, you must make a DC 17 Dexterity saving throw – if you fail (or have no helmet), one of your eyes is destroyed. From now on, you suffer disadvantage on Wisdom (Perception) checks that rely on sight, and on ranged attack rolls. If a subsequent injury damages your other eye, you are permanently blinded. Magic such as Regenerate or Wish can restore the lost eye. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>21-22</td><th>Scarred Eye</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), one of your eyes is scarred by the attack, costing its sight for a time. From now on, you suffer disadvantage on Wisdom (Perception) checks that rely on sight, and on ranged attack rolls. If a subsequent injury damages your other eye, you are blinded. The damaged eye's function can be restored either by succeeding at a DC 17 Constitution saving throw after a long rest, or by magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>23-26</td><th>Pelvic Injury</th><td>Either your pelvis is struck a crippling blow, or the attack destroys your nethers. Whenever you attempt a Strength (Athletics) check or take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw or lose 1d6 hit points. You also can't ride a horse without suffering 1d10 hit points. Finally, this injury renders you permanently infertile. This flaw ends after a base recovery time of 70 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish, although the infertility can only be reversed by Greater Restoration or Remove Curse. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>27-28</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by either Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>29-30</td><th>Hand Injury</th><td>The attack costs you several fingers. There is a 50% chance of the affected hand being your dominant hand. You can just about carry a shield, but if it's a weapon hand, your weapon attacks suffer a -2 penalty, unless you are trained in either the Dual Wielder feat or the Two-Weapon Fighting Style. Also, if it is your dominant hand, if you attempt to cast a spell with somatic components, you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. These penalties last a base recovery time of 40 days (see Recovery above). This flaw can be removed by magic such as Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>31-32</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>33-34</td><th>Old Battle Wound</th><td>You more or less recover, but become plagued for years with recurring pains. After every long rest, you must succeed at a DC 11 Constitution saving throw or suffer -2 to your Dexterity and Wisdom scores until the next long rest. This penalty can be neutralised by special salves, prepared by a character proficient in Medicine or using a herbalism kit with which they are proficient. This flaw can be removed through magic such as Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-36</td><th>Useless Shield</th><td>Unless your shield is made of adamantine, the attack leaves it ruined and worthless. It provides no bonus to AC until it is repaired or subjected to a mending spell. If you don't have a shield, treat this result as Ruined Armour. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>37-38</td><th>Blinding Refraction</th><td>The focused beam not only puts you down, but also, by sheer chance, reflects off a shiny surface to strike another creature. A random creature without total cover from you (possibly including the attacker) must succeed at a DC14 Dexterity saving throw (this roll is made with advantage if they have half or three-quarters cover), or be blinded until the end of their next turn. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>39-41</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards angels or sorcerers) or even the type of attack (such as a fear of sunlight). This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>42-44</td><th>Horrible Scar</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), you are disfigured to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic like Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>45-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
          ...
          <b-tab index="12" title="Slashing">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>7-9</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Disembowelment, Fatal Wound or worse). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>10-11</td><th>I Can't Move!</th><td>Brain trauma leaves you fully paralysed, at least for a short time. You can do little more than speak, but can still cast spells that don't require somatic components. However, as you can't feel much of your body, you gain advantage on any Constitution saving throw to maintain concentration on spells due to receiving damage. After every long rest, the character can make a DC 17 Constitution saving throw to end the paralysis. This flaw can also be ended by magic such as Freedom of Movement, Greater Restoration, Heal Minor Injury, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>12-13</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>14-15</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>16-17</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>18-19</td><th>Head Injury</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), ten head trauma damages your mental facilities somehow, often leaving a bald patch at the scar. Roll 1d3: 1: you lose 1 point from your Intelligence score; 2: you lose 1 point from your Wisdom score; 3: you lose 1 point from your Charisma score. This flaw is often accompanied by speech or memory problems, requiring you to relearn basic skills and social niceties. If the same ability score is affected a second time or more in the future by this flaw, you must succeed at a DC 14 Constitution saving throw or also suffer the Coma flaw. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>20-21</td><th>Broken Arm</th><td>As the attack slams home, an audible 'crack' renders an arm close to useless for a time. There is a 50% chance that the broken arm is your dominant arm and if so, unless you are trained in the Dual Wielder feat or the Two-Weapon Fighting Style, you suffer disadvantage with weapon attacks. If it is your other arm, you cannot wear a shield. This flaw ends after a base recovery time of 30 weeks (see Recovery above), or if you receive magic such as a Greater Restoration, Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>22-23</td><th>Leg Wound</th><td>Your leg is badly damaged. Until a base recovery time of 40 days has passed (see Recovery above), you must use a cane or crutch to move at half speed, you fall prone after using the dash action, and you suffer disadvantage on Dexterity checks made to balance. Even after the worst of the damage has passed, your speed on foot is reduced by 5 feet. The limb can be restored by magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>24-25</td><th>Broken Ribs</th><td>Your rib cage is partly caved in. Whenever you attempt a Strength (Athletics) check or attempt to take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw. If you fail the save, you lose your action and can't use reactions until the start of your next turn. This flaw ends after a base recovery time of 50 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>26-27</td><th>Hand Injury</th><td>The attack costs you several fingers. There is a 50% chance of the affected hand being your dominant hand. You can just about carry a shield, but if it's a weapon hand, your weapon attacks suffer a -2 penalty, unless you are trained in either the Dual Wielder feat or the Two-Weapon Fighting Style. Also, if it is your dominant hand, if you attempt to cast a spell with somatic components, you must first succeed on a DC 11 Constitution saving throw or lose your action that turn – the spell slot, if any, is not lost. These penalties last a base recovery time of 40 days (see Recovery above). This flaw can be removed by magic such as Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>28-29</td><th>Scalp Cut</th><td>Unless you are wearing a helmet, you suffer the following flaw: it's only a shallow wound, but that doesn't seem to stop it bleeding profusely, and blinding you with your own blood. When you roll for initiative at the start of combat, on the result of an odd number, you are blinded. You can use a bonus action to wipe away the blood to avoid being blinded until the beginning of your next turn. This flaw ends either by receiving the spell Heal Minor Injury, or after a long rest. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>30-31</td><th>Bleeding Wound</th><td>Frustratingly, the latest injury is loathe to stop bleeding. When you roll for initiative at the start of combat, on the result of an odd number, the wound re-opens: you suffer 1 damage at the end of each of your turns, unless a character uses an action to bind the wound. This flaw ends if you receive the spell Heal Minor Injury, or if you succeed at a DC 17 Constitution saving throw after a long rest: if you fail this save the first time, you gain a +5 bonus in future. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>32-34</td><th>Ruined Armor</th><td>Unless your armour is made of adamantine, the attack leaves it badly damaged, affording little protection and fitting badly. You suffer -2 from your AC. This penalty lasts until it is replaced, repaired or subject to a Mending spell. If you have no armour, treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-36</td><th>Useless Shield</th><td>Unless your shield is made of adamantine, the attack leaves it ruined and worthless. It provides no bonus to AC until it is repaired or subjected to a mending spell. If you don't have a shield, treat this result as Ruined Armour. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>37-38</td><th>Infected Wounds</th><td>The damage refuses to properly heal, and instead becomes swollen and leaks a noisome pus. Your hit point maximum is reduced by 1 for every 24 hours the wound persists. If your hit point maximum drops to 0, you die. The wound heals if you receive the spell Heal Minor Injury or, alternatively, someone can tend to the wound and make a DC 14 Wisdom (Medicine) check once every 24 hours. After ten successes, the wound heals. Characters who are immune to disease treat this result as Exhausted instead. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>39-40</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards orcs or sorcerers) or even the type of attack (such as a fear of knives). This flaw can be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-42</td><th>Horrible Scar</th><td>If you wear a helmet, you must make a DC 14 Dexterity saving throw – if you fail (or have no helmet), you are disfigured to the extent that the wound can't be easily concealed, or palated. You have disadvantage on Charisma (Persuasion) checks and advantage on Charisma (Intimidation) checks. Magic like Heal, Regenerate or Wish can remove the scar. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
                <tr><td>99+</td><th>I'm... I'm Alright!</th><td>The gods must be smiling today – the blow seemed worse than it actually is, and you are assumed dead. Rather than making any death saving throws, you are instead stabilised and returned to 1 hit point and, at the beginning of your next turn, regain 1d10 hit points and can act as normal, gaining advantage on your first attack that turn.</td></tr>
              </tbody>
          ...
          <b-tab index="13" title="Thunder">
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr><td>4</td><th>Coma</th><td>You enter a death-like sleep from which nothing can seemingly awaken you, though dim life signs still remain. You remain unconscious, even after being stabilised. Following a long rest, make a death saving throw. Three failed saves result in death (possibly due to lack of fluids, amongst other complications), but a result of 15 or means the coma ends. If and when you awaken, you suffer three levels of exhaustion (these exhaustion levels can be removed normally). The coma can also be ended prematurely by magic such as Dream, Greater Restoration, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>5-8</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound or Instant Death). You also gain 1 level of exhaustion.</td></tr>
                <tr><td>9-10</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>11-12</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>13-14</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>15-17</td><th>Head Injury</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), ten head trauma damages your mental facilities somehow, often leaving a bald patch at the scar. Roll 1d3: 1: you lose 1 point from your Intelligence score; 2: you lose 1 point from your Wisdom score; 3: you lose 1 point from your Charisma score. This flaw is often accompanied by speech or memory problems, requiring you to relearn basic skills and social niceties. If the same ability score is affected a second time or more in the future by this flaw, you must succeed at a DC 14 Constitution saving throw or also suffer the Coma flaw. This flaw can be removed by Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>18-21</td><th>Deafened</th><td>If you wear a helmet, you must make a DC 14 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, the attack leaves you deafened. This flaw is removed if you receive magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>22-23</td><th>Broken Ribs</th><td>Your rib cage is partly caved in. Whenever you attempt a Strength (Athletics) check or attempt to take any action in combat (other than casting a spell), you must succeed at a DC 11 Constitution saving throw. If you fail the save, you lose your action and can't use reactions until the start of your next turn. This flaw ends after a base recovery time of 50 days (see Recovery above), or if you receive magic such as Heal, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>24-26</td><th>Debilitating Migraines</th><td>The attack permanently damaged your brain, and you become plagued with nosebleeds and nauseating headaches. These come most frequently in times of stress, or following loud noise. When rolling for initiative at the start of combat, or when you are hit by an attack causing thunder damage, you must make a DC 11 Constitution saving throw. If you fail the save, the migraines come again: you suffer disadvantage on future initiative and Wisdom (Perception) checks. The migraine attack ends when you take a short or long rest. This flaw can only be removed by magic such as Greater Restoration, Heal, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>27-30</td><th>Punch Drunk</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then due to hearing impairment or brain trauma, your coordination is often disrupted. After every short or long rest, you must succeed at a DC 11 Constitution or Wisdom saving throw (your choice), or suffer disadvantage on Dexterity (Acrobatics) checks. This penalty lasts until the next short or long rest. Additionally, if you are knocked prone, it costs you double the standard movement to stand up. This flaw can be removed through magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>31-34</td><th>Partially Deafened</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, the attack leaves your hearing permanently muffled. You suffer disadvantage on Wisdom (Perception) checks that rely on hearing. This flaw can be removed through magic such as Greater Restoration, Heal, Heal Minor Injury, Regenerate or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>35-37</td><th>Shell-Shock</th><td>Either due to brain damage or a lifetime of facing horrors and death, you are somewhat indecisive and slow to react. You suffer a penalty of -2 to your Initiative. This flaw can be removed through magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>38-40</td><th>Troubled Sleep</th><td>Unless you are immune to being frightened, you suffer the following flaw: though you more or less recover, your sleep or trance is ravaged by inescapable nightmares, and rarely affords much rest. You must succeed on a DC 11 Charisma or Wisdom saving throw (your choice) after every long rest, or only recover a quarter of your hit dice. If you beat the save DC by 10 or more, the flaw ends. It can also be removed by magic such as Dream, Greater Restoration, Remove Curse or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>41-42</td><th>Personality Change</th><td>In the aftermath of the attack, either as a result of head injury or due to post-traumatic stress, you soon exhibit a shift in personality. Roll 1d100 and consult the Indefinite Madness table (on page 260 of the Dungeon Master's Guide) to see what permanent flaw you gain. This flaw can only be removed by magic such as Greater Restoration or Wish, or possibly by some kind of long-term therapy, at the Dungeon Master's discretion. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>43-44</td><th>Shrapnel</th><td>As the sound booms around you, its tones shatter nearby fragile objects (such as windows or a non-magic metal weapon), and the shards slice into an unfortunate witness. A random creature (possibly including the attacker) within 30 feet of you must succeed on a DC 14 Dexterity saving throw, or suffer 1d6 piercing damage; this damage may be higher at the Dungeon Master's discretion, depending on the size and weight of the shattered material. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>45-46</td><th>Fixation</th><td>Following recovery, you develop an unhealthy fixation. Roll 1d6: on a 1-3, you nurture a bitter enmity; on a 4-6, you develop an overpowering phobia. If you are immune to being frightened, then this result is bitter enmity. You should work with the Dungeon Master on the phrasing of the new flaw: your hatred or phobia may focus on some element of the attacker's identity (for example, a mindless hatred towards elementals or sorcerers) or even the type of attack (such as a fear of storms). This flaw can be removed by magic such as Greater Restoration or Wish. You also gain 1 level of exhaustion.</td></tr>
                <tr><td>47-96</td><th>Exhausted</th><td>It will take time to fully recover from your wounds and you are exhausted. Gain 1 level of exhaustion.</td></tr>
