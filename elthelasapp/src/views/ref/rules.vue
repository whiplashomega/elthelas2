<template>
  <div>
    <b-tabs>
      <b-tab index="0" title="Advantage and Disadvantage">
      ...
      <b-tab index="3" title="Leveling Up">
        <h2>Leveling Up</h2>
        <p>
      ...
      <b-tab index="4" title="Multiclassing">
        <h2>Multiclassing</h2>
        <p>
