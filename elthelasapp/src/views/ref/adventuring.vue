<template>
  <div>
    <b-tabs>
      <b-tab index="0" title="Between Adventures">
        <h2>Between Adventures</h2>
          <p>
      ...
      <b-tab index="1" title="Movement">
        ...
        <h3>Special Types of Movement</h3>
        <p>
      ...
      <b-tab index="3" title="The Environment">
        <h2>Environment</h2>
        <p>
...
<script src="./js/adventuring.js"></script>
<style></style>