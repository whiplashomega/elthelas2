...
import summary from '@/components/strongholdbuilder/summary.vue';
...
export default {
  ...
  setup () {
    ...
    const { bankRevenue, buildingMaintenance, getBuyTable: buyTable, calcRevRatio,
            calcTotalRevenue, calculateIncome, calculateRevenue, calcGrossRevenue,
            expenses, getPop, grossRevenue, headTax, improvementRevenue, incomeTax,
            neededStaff, privateLaborers, propertyTax, rents, resourceCost, resourceRevenue,
            sellTable, staffBeds, staffTypes, staffSummary, stronghold, taxRevenue,
            taxEfficiency, totalEmployees, totalPrivateEmployed, totalSalary, totalStorage,
            unemploymentRate, unrest, getPopNeeds: popNeeds, getPrivateProduction: privateProduced, usedStorage, vassalTax
    } = storeToRefs(strongholdStore);
    
    const { getAllImprovements, newStronghold, getAllStrongholds, loadStronghold,
            loadStrongholdById, saveStronghold, saveNewStronghold, deleteStronghold,
            addToTreasury, buyResource } = strongholdStore;
    ...
    return {
      ...
      getAllImprovements, newStronghold, getAllStrongholds, loadStronghold,
      loadStrongholdById, saveStronghold, saveNewStronghold, deleteStronghold,
      addToTreasury, buyResource
    };
  },
  computed: {
    reverseTransactions () {
