...
<p>
    In a pantheon, every deity has influence over different aspects of mortal life and civilization, called a deity's domain.  All
    the domains over which a deity has influence are called the deity's portfolio.  For example, the portfolio of the greek god
    Apollo includes the domains of Knowledge, Life, and Light.  As a cleric, you choose one aspect of your deity's portfolio to
    emphasize, and you are granted powers related to that domain.
</p>
<p>
    Your choice might correspond to a particular sect dedicated to your deity.  Apollo, for example, could be worshiped in one
    region as Phoebus ("radiant") Apollo, emphasizing his influence over the Light domain, and in a different place as Apollo
    Acesius ("healing"), emphasizing his association with the Life domain. Alternatively, your choice of domain could simply
    be a matter of personal preference, the aspect of the deity that appeals to you most.
</p>
<p>
    Each domain's description gives examples of deities
who have influence over that domain.
</p>
  <ul class="list-inline">
    <li class="list-inline-item"><button @click="showClass('air')" class="racebutton btn btn-default">Air</button></li>
    <li class="list-inline-item"><button @click="showClass('arcana')" class="racebutton btn btn-default">Arcana</button></li>
    <li class="list-inline-item"><button @click="showClass('death')" class="racebutton btn btn-default">Death</button></li>
    ...
    <li class="list-inline-item"><button @click="showClass('war')" class="racebutton btn btn-default">War</button></li>
    <li class="list-inline-item"><button @click="showClass('water')" class="racebutton btn btn-default">Water</button></li>
  </ul>
  <div class="racediv" id="air">
		<h2>Air Domain</h2>
		...
		<h4>Disciple of Air</h4>
		<p>
			Also starting at 1st level, your lightning spells are more effective, you add your wisdom
			modifier to the damage of any spell you cast that does lightning damage.
		</p>
		<h4>Channel Divinity: Gale</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
		to create a gale of wind like a tornado
		</p>
		<p>
			As an action, you present your holy symbol and gale force winds permeate the area.  The area within 60 ft of you becomes filled with strong winds.  You and a number of creatures equal to your wisdom
			modifier that you select ignore these winds, meanwhile for any other creature moving 1 ft requires 2 ft of movement as they battle through the strong winds.  Additionally, when the winds start each
			creature effected must make a strength saving throw or be knocked prone.
		</p>
		<h4>Burst of Wind</h4>
		<p>
			At 6th level your God grants you the ability to manipulate winds around you.
			As an action you can use the force of the wind to knock over creatures and move objects.  To do so, select a 10 ft cube within 60 ft of you.  Any creatures in that area must make a strength
			saving throw or be pushed 10 ft in a direction of your choice and fall prone, they choose which effect they are subjected to.  If they succeed they are not affected.  Objects in the area
			that are not secured are automatically pushed 10 ft away.
		</p>
		<h4>Lightning Strike</h4>
		<p>
			At 8th level, you gain the ability to infuse your weapon
		strikes with lightning energy. Once on each of your turns
		...
		<h4>Living Air</h4>
		<p>
			At 17th level you gain the ability to summon a air elemental once per day.  The air elemental serves you and only you faithfully,
			obeying your verbal commands.  It stays with you until it is killed, but you can only have one elemental companion such as this at
			a time.  Summoning the elemental requires 1 minute of intense concentration and meditation, during which you cannot move more than 5 feet from the location you started
			the summoning, and must use your action on every turn to continue the summoning ritual.
		</p>
  </div>
	<div class="racediv" id="arcana">
		<h2>Arcana Domain</h2>
		...
		<table class='classtable table table-striped'>
			...
			<tbody>
				<tr>
					<td>1st</td><td>detect magic, magic missile</td>
				</tr>
				<tr>
					<td>3rd</td><td>magic weapon, Nystul's magic aura</td>
				</tr>
				<tr>
					<td>5th</td><td>dispel magic, magic circle</td>
				</tr>
				<tr>
			...
			<h4>Channel Divinity: Arcane Abjuration</h4>
			<p>
				Starting at 2nd level, you can use your Channel Divinity
			...
			<h4>Arcane Banishment</h4>
			<table class='classtable table table-striped'>
				<thead>
					<tr>
						<th>Cleric Level</th><th>Banishes Creatures of CR ...</th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>5th</td><td>1/2 or lower</td>
					</tr>
					<tr>
						<td>8th</td><td>1 or lower</td>
					</tr>
					<tr>
						<td>11th</td><td>2 or lower</td>
					</tr>
					<tr>
						<td>14th</td><td>3 or lower</td>
					</tr>
					<tr>
						<td>17th</td><td>4 or lower</td>
					</tr>
				</tbody>
			</table>
		<h4>Spell Breaker</h4>
	...
	<div class="racediv" id="death">
		...
		<table class="classtable table table-striped">
			...
			<tbody>
				<tr>
					<td>1st</td><td>false life, ray of sickness</td>
				</tr>
				<tr>
					<td>3rd</td><td>blindness/deafness, ray of enfeeblement</td>
				</tr>
				<tr>
		...
		<h4>Divine Strike</h4>
		<p>
			At 8th level, the cleric gains the ability to infuse his or
			her weapon strikes with necrotic energy. Once on each
			of the cleric's turns when he or she hits a creature with a
			weapon attack, the cleric can cause the attack to deal an
			extra 1d8 necrotic damage to the target. When the cleric
			reaches 14th level, the extra damage increases to 2d8.
		</p>
		<h4>Improved Reaper</h4>
		<p>
			Starting at 17th level, when the cleric casts a
			necromancy spell of 1st through 5th level that targets
			only one creature, the spell can instead target two
			creatures within range and within 5 feet of each other. If
			the spell consumes its material components, the cleric
			must provide them for each target.
		</p>
	</div>
	<div class="racediv" id="earth">
		<h2>Earth Domain</h2>
		...
		<p>
			You learn the magic stone and mold earth cantrips.
		</p>
		<h4>Channel Divinity: Armor of Stone</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
		to strengthen your armor with the strength of the earth itself.
		</p>
		<p>
			As an action, you present your holy symbol and perform an incantation.  Pick a number of willing creatures equal
			to your wisdom modifier within 30 ft of you.  Each of those creatures has their armor class increased by 2 for 1 minute.
		</p>
		<h4>Move in the Earth</h4>
		<p>
			Also Starting at 6th level, you gain a burrow speed equal to your movement speed.  When you burrow you leave no trail behind you,
			as your body melds itself into the earth itself.
		</p>
		<h4>Earth Strike</h4>
		<p>
			At 8th level, you gain the ability to infuse your weapon
		strikes with fire energy. Once on each of your turns
		when you hit a creature with a weapon attack, you can
		cause the attack to deal an extra 1d8 magic bludgeoning damage to
		the target. When you reach 14th level, the extra damage
		increases to 2d8.
		</p>
		<h4>Living Earth</h4>
		<p>
			At 17th level you gain the ability to summon an earth elemental once per day.  The earth elemental serves you and only you faithfully,
			obeying your verbal commands.  It stays with you until it is killed, but you can only have one elemental companion such as this at
			a time.  Summoning the elemental requires 1 minute of intense concentration and meditation, during which you cannot move more than 5 feet from the location you started
			the summoning, and must use your action on every turn to continue the summoning ritual.
		</p>
	</div>
	<div class="racediv" id="fire">
		<h2>Fire Domain</h2>
		...
		<p>
			Also starting at 1st level, your fire spells are more effective, you add your wisdom
			modifier to the damage of any spell you cast that does fire damage.
		</p>
		<h4>Channel Divinity: Fire Burst</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
		to create divine flames
		</p>
		<p>
			As an action, you present your holy symbol and nearby enemies burst into flame.  Pick a number of opponents equal
			to your wisdom modifier within 30 feet of you.  Each of those creatures must make a constitution saving throw or catch fire.  The fire does
			3d6 fire damage every round at the start of that creatures turn until someone uses an action to extinguish the flames.
		</p>
		<h4>Manipulate Flames</h4>
		<p>
			At 6th level your God grants you the ability to manipulate flames.  On your turn, you can manipulate any non-magical flame within 60 feet of you.
			As an action you can extinguish any fire smaller than a 5 foot cube, or turn a small fire (such as a torch) into a conflagration in a neighboring
			square.  Any creature caught in the conflagration must make a dexterity save, taking 2d6 fire damage on a failed save, or half as much
			on a successful one.  The conflagration lasts for only 1 round unless their is fuel available in the square, in which case it lasts
		...
		strikes with fire energy. Once on each of your turns
		when you hit a creature with a weapon attack, you can
		cause the attack to deal an extra 1d8 fire damage to
		the target. When you reach 14th level, the extra damage
		increases to 2d8.
		</p>
		<h4>Living Fire</h4>
		<p>
			At 17th level you gain the ability to summon a fire elemental once per day.  The fire elemental serves you and only you faithfully,
			obeying your verbal commands.  It stays with you until it is killed, but you can only have one elemental companion such as this at
			a time.  Summoning the elemental requires 1 minute of intense concentration and meditation, during which you cannot move more than 5 feet from the location you started
			the summoning, and must use your action on every turn to continue the summoning ritual.
		</p>
	</div>
	<div class="racediv" id="craft">
		<h2>Forge Domain</h2>
		...
		<table class="classtable table table-striped">
			...
			<tbody>
				<tr>
					<td>1st</td><td>searing smite, shield</td>
				</tr>
				<tr>
					<td>3rd</td><td>Heat Metal, Magic Weapon</td>
				</tr>
				<tr>
					<td>5th</td><td>Elemental Weapon, Protection from Energy</td>
				</tr>
				<tr>
					<td>7th</td><td>Fabricate, Wall of Fire</td>
				</tr>
				<tr>
					<td>9th</td><td>Animate Objects, Creation</td>
				</tr>
			</tbody>
		</table>
		...
		<h4>Channel Divinity: Artisan's Blessing</h4>
		<p>
		...
		<h4>Soul of the Forge</h4>
		<p>
			Starting at 6th level, your mastery	of the forge grants	you	a number	of	special	abilities:
		</p>
		<ul>
			<li>You	gain a +1 bonus	to AC while	you	are	wearing	medium or heavy	armor</li>
			<li>You	gain resistance to fire damage.</li>
			<li>When you hit a construct with an attack, you deal additional force damage to it equal to your cleric level.</li>
		</ul>
		<h4>Divine Strike</h4>
		<p>
			At 8th level, you gain the ability to infuse your weapon strikes with the fiery power of the forge. Once on each of your turns when you	hit a creature with a weapon attack, you can cause the attack to deal an extra 1d8 fire damage to the target. When you reach 14th level, the extra damage increases to 2d8.
		</p>
		<h4>Saint of Forge and Fire</h4>
		<p>
	...
	<div class="racediv" id="knowledge">
		...
		<p>
		The gods of knowledge-Amathera and Tock-value learning and
		...
		<h4>Channel Divinity: Knowledge of the Ages</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
		...
		<h4>Channel Divinity: Read Thoughts</h4>
		<p>
		...
		<p>
			<strong>Object Reading.</strong> Holding an object as you meditate,
		...
		<p>
			<strong>Area Reading.</strong> As you meditate, you see visions
	...
	<div class="racediv" id="life">
		...
		gods (such as Lathander, Pelor, and Re-Horakhty), gods of healing or endurance (such as Ilmater, Mishakal,
		...
		<h4>Channel Divinity: Preserve Life</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
	...
	<div class="racediv" id="light">
		<h2>Light Domain</h2>
		<p>
			Gods of light promote the ideals of rebirth and
		renewal, truth, vigilance, and beauty, often using the
		symbol of the sun. Some of these gods are portrayed
		as the sun itself or as a charioteer who guides the sun across the sky. Others are tireless sentinels whose eyes
		...
		<h4>Channel Divinity: Radiance of the Dawn</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
	...
	<div class="racediv" id="nature">
		<h2>Nature Domain</h2>
		<p>
			Gods of nature are as varied as the natural world
		itself, from inscrutable gods of the deep forests to
		...
		<h4>Channel Divinity: Charm Animals and Plants</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
	...
	<div class="racediv" id="tempest">
		...
		<p>
			Gods whose portfolios include the Tempest domain govern storms, sea, and
		...
		common folk, either to keep those folk on the path of righteousness or to encourage them to offer sacrifices of
		...
		<h4>Channel Divinity: Destructive Wrath</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
	...
	<div class="racediv" id="trade">
		...
		<table class='classtable table table-striped'>
			...
			<tbody>
				<tr>
					<td>1st</td><td>Comprehend Languages, Charm Person</td>
				</tr>
				<tr>
					<td>3rd</td><td>Zone of Truth, Calm Emotions</td>
				</tr>
				<tr>
					<td>5th</td><td>Tongues, Sending</td>
				</tr>
				<tr>
					<td>7th</td><td>Freedom of Movement, Dimension Door</td>
				</tr>
				<tr>
					<td>9th</td><td>Teleportation Circle, Rary's Telepathic Bond</td>
				</tr>
			</tbody>
		</table>
		<h4>Bonus Proficiency</h4>
		<p>Starting when you take this domain at 1st level you gain proficiency with one type of Artisan's tools of your choice, the persuasion skill, and in 2 additional languages</p>
		<h4>Channel Divinity: Appraisal</h4>
		<p>Starting at 2nd level, whenever you touch an object you can use an action and a use of your channel divinity feature to learn what it is and its monetary value, if any.
		You learn about the object as if you had cast the 'identify' spell on it.  Additionally you get an idea of what it's approximate monetary value is on the open market (although
		individual buyers may offer different amounts).</p>
		<h4>Fast Travel</h4>
		<p>
			Starting at 6th level your movement speed increases by 10 ft.  Additionally once per day you can use your action to increase the movement speed of any friendly creature
			within 30 ft of you by 10 ft for 1 hour.
		</p>
		<h4>Dimensional Pocket</h4>
		<p>
			Starting at 8th level you can access a dimensional pocket where you can store your acquisitions and wealth.  It takes a 1 minute ritual to access the dimensional pocket, after
			which you can add or remove any non-living object that you can hold in your hands and which is smaller than 10 ft in all dimensions.  No other creature can access your
			pocket plane, however, if you die all of it's contents appear near your corpse.
		</p>
		<h4>World Wanderer</h4>
		<p>
			Starting at 14th level, you add the spells Teleport and Mordenkainen's Magnificent Mansion to your list of domain spells, also you can ignore the material component cost of Teleportation Circle.
		</p>
		<h4>Channel Divinity: Money is no Object</h4>
		<p>
			Starting at 17th level you can use your channel divinity feature to turn other metals into gold.  Choose one object made of metal of less than 50 lbs and less than 5 ft in any dimension.
			As an action you can turn that object into pure gold.  If that object is an armor or weapon, it's damage or AC are reduced by 2.
		</p>
	</div>
	<div class="racediv" id="trickery">
		<h2>Trickery Domain</h2>
		<p>
			Gods of trickery are mischief-makers and instigators who stand
			...
			captives, and flouting hollow traditions. They prefer subterfuge, pranks, deception, and theft rather than
		...
		<h4>Channel Divinity: Invoke Duplicity</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
		...
		<h4>Channel Divinity: Cloak of Shadows</h4>
		<p>
	...
	<div class="racediv" id="war">
		...
		excellence and courage. In either case, the gods of war watch over warriors and reward them for their great
		...
		and chivalry as well as gods of destruction and pillage and gods of
		conquest and domination. Other war gods take a more neutral stance, promoting war
		...
		<table class='classtable table table-striped'>
			...
			<tr>
				<td>9th</td><td>f lame strike, hold monster</td>
			</tr>
		</table>
		<h4>Bonus Proficiencies</h4>
		<p>
		...
		<h4>Channel Divinity: Guided Strike</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity
		...
		<h4>Channel Divinity: War God's Blessing</h4>
		<p>
	...
	<div class="racediv" id="water">
		...
		<h4>Disciple of the Sea</h4>
		<p>
			Also starting at 1st level, your cold spells are more effective, you add your wisdom
			modifier to the damage of any spell you cast that does cold damage.
		</p>
		<h4>Channel Divinity: Downpour</h4>
		<p>
			Starting at 2nd level, you can use your Channel Divinity to create a rainstorm as an action.  The rainstorm occurs in a cylinder with a radius of 300 ft.  Vision within the rainstorm is lightly obscured beyond
			100 ft, fires within the area are put out, and all creatures in it have resistance to fire damage.  The rainstorm drops a cubic foot of water on each 5 ft square every round that it continues.  You
			can dismiss the storm at any time, or it will end on its own after 10 minutes.
		</p>
		<h4>State Change</h4>
		<p>
			At 6th level your God grants you the ability to manipulate water around you.
			As an action you can use the powers granted by your God to change a small of water to ice or steam, or ice or steam into water.  To do so, select a 5 ft cube within 60 ft of you.
			If the square contains water you can choose to turn that water to ice or steam.  If you change it into ice it does 2d6 cold damage to any creature in or adjacent to that square and any
			creature in that square must make a strength save against your spell save DC or be paralyzed. They can attempt the save again at the end of each turn.  If they succeed on the save the ice breaks into
			small shards.  If you turn it into steam it does 3d8 fire damage instead.  If you change ice or steam into water it has no additional adverse effect.
			The transformation lasts for 1 minute, after which the effect is reversed (potentially doing damage if steam or ice that was turned into water reverts into ice or steam).  You can make
			this change a number of times per day equal to your wisdom modifier.
		</p>
		<h4>Cold Strike</h4>
		<p>
			At 8th level, you gain the ability to infuse your weapon
		strikes with cold energy. Once on each of your turns
		when you hit a creature with a weapon attack, you can
		...
		<h4>Living Water</h4>
		<p>
			At 17th level you gain the ability to summon a water elemental once per day.  The water elemental serves you and only you faithfully,
			obeying your verbal commands.  It stays with you until it is killed, but you can only have one elemental companion such as this at
			a time.  Summoning the elemental requires 1 minute of intense concentration and meditation, during which you cannot move more than 5 feet from the location you started
			the summoning, and must use your action on every turn to continue the summoning ritual.
		</p>
...
<style src="./domains.scss" lang="scss" scoped></style>
