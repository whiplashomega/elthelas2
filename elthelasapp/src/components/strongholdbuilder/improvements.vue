    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        ...
        <div v-for="improvement in countrysideImprovements" :key="improvement.id">
          <div v-if="improvement.id !== 'new-land' && improvement.id !== 'clear-land'">
            <improvement :improvement="improvement" :stronghold="stronghold" />
          </div>
        </div>
      </div>
            ...
            <tbody>
              <tr v-for="improvement in availableImprovements" :key="improvement.id">
                ...
                <td>
                  ...
                  <div v-for="(res, key) in improvement.revenue" :key="key">
                    <div  v-if="res !== 0">{{ key }}: {{ res }}</div>
                  </div>
                </td>
                ...
                <td>
                  ...
                  <div v-for="(res, key) in improvement.resourceCost" :key="key">
                    <div v-if="res !== 0">{{ key }}: {{ res }}</div>
                  </div>
                </td>
