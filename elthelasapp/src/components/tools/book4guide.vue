<template>
  <div>
    ...
    <div id="chapter1startingout">
      ...
      <p>
        There are a few factions that are not available to player characters for this campaign (listed below).  These factions are directly opposed to the mission of Cur'Estan.
      </p>
      <ul>
      ...
      <p class="row">
        <img src="https://elthelas-images.herokuapp.com/maps/cities/curestan.png" alt="Map of Cur'Estan"
             class="col-sm-12" id="curestanmap" />
      </p>
      <p>
