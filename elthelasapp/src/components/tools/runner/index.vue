<template>
  <div class="col-sm-12">
    ...
    <b-table show-empty
      ...
      <template slot="name" slot-scope="row"><a href="#" @click.stop="addToEncounter(row.item, row.index, $event.target)"><span v-if="row.item._id">DB </span>{{ row.value }}</a></template>
    </b-table>
