          ...
          <div class="col">
            <table class="abilitytable">
              ...
              <tbody>
                ...
                <tr>
                  <th>Adjustment</th>
                  <td><input type="number" v-model="character.statadjust[0]" class="charsheet-num"></td>
                  <td><input type="number" v-model="character.statadjust[1]" class="charsheet-num"></td>
                  <td><input type="number" v-model="character.statadjust[2]" class="charsheet-num"></td>
                  <td><input type="number" v-model="character.statadjust[3]" class="charsheet-num"></td>
                  <td><input type="number" v-model="character.statadjust[4]" class="charsheet-num"></td>
                  <td><input type="number" v-model="character.statadjust[5]" class="charsheet-num"></td>
                </tr>
                <tr>
                  <th>Bonus</th>
