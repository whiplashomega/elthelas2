export default [
  {
    "Item": "Giant Slayer $Name",
    "Type": "Weapon ($Name)",
    "Cost (gp)": "7000",
    "Rarity": "Rare",
    "Attunement": "No",
    "Effect": "You gain a +1 bonus to attack and damage rolls made with this magic $Name.\nWhen you hit a giant with it, the giant takes an extra 2d6 damage of the weapon's type and must succeed on a DC 15 Strength saving throw or fall prone. For the purpose of this weapon, \"giant\" refers to any creature with the giant type, including ettins and trolls."
  },
  {
    "Item": "$Name of Venom",
    "Type": "Weapon ($Name)",
  ...
  },
  {
    ...
    "Rarity": "Very Rare",
    "Attunement": "Yes",
    "Effect": "You can use a bonus action to toss this magic $Name into the air and speak the command word. When you do so, the $Name begins to hover, flies up to 30 feet, and attacks one creature of your choice within 5 feet of it. The $Name uses your attack roll and ability score modifier to damage rolls.\nWhile the $Name hovers, you can use a bonus action to cause it to fly up to 30 feet to another spot within 30 feet of you. As part of the same bonus action, you can cause the $Name to attack one creature within 5 feet of it. After the hovering $Name attacks for the fourth time, it flies up to 30 feet and tries to return to your hand. If you have no hand free, it falls to the ground at your feet. If the $Name has no unobstructed path to you, it moves as close to you as it can and then falls to the ground. It also ceases to hover if you grasp it or move more than 30 feet away from it."
  },
  {
    "Item": "Dragon Slayer $Name",
    "Type": "Weapon ($Name)",
    "Cost (gp)": "8000",
    "Rarity": "Rare",
    "Attunement": "No",
  ...
  },
  {
    ...
    Attunement: "No",
    Rarity: "Uncommon",
    Effect: "You have a +1 bonus to attack and damage rolls made with this " + "$Name" + ".",
    "Cost (gp)": 3000
  },
  {
    Item: "+2 " + "$Name",
    ...
    Attunement: "No",
    Rarity: "Rare",
    Effect: "You have a +2 bonus to attack and damage rolls made with this " + "$Name" + ".",
    "Cost (gp)": 8000
  },
  {
    Item: "+3 " + "$Name",
    ...
    Attunement: "No",
    Rarity: "Very Rare",
    Effect: "You have a +3 bonus to attack and damage rolls made with this " + "$Name" + ".",
    "Cost (gp)": 14000
  },
  {
    Item: "$Name" + " of Warning",
    Type: "Weapon (" + "$Name" + ")",
    Attunement: "Yes",
    Rarity: "Uncommon",
  ...
  },
  {
    ...
    Attunement: "No",
    Rarity: "Uncommon",
    Effect: "Whenever an attack with this " + "$Name" + " hits it does an additional 1d6 " + "acid" + " damage in addition to its normal effects.",
    "Cost (gp)": 4000
  },
  {
  ...
  },
  {
    ...
    Attunement: "No",
    Rarity: "Uncommon",
    Effect: "Whenever an attack with this " + "$Name" + " hits it does an additional 1d6 " + "cold" + " damage in addition to its normal effects.",
    "Cost (gp)": 4000
  },
  {
  ...
  },
  {
    ...
    Attunement: "No",
    Rarity: "Uncommon",
    Effect: "Whenever an attack with this " + "$Name" + " hits it does an additional 1d6 " + "lightning" + " damage in addition to its normal effects.",
    "Cost (gp)": 4000
  },
  {
  ...
  },
  {
    ...
    Attunement: "Yes",
    Rarity: "Uncommon",
    Effect: "This " + "$Name" + " instantly returns to the wielders hand after an attack is made with it, regardless of whether the attack hits or misses. If the owner does not have a hand free it instead falls to the ground at his/her feat.",
    "Cost (gp)": 1500,
    Test: /thrown/
  },
  {
    ...
    Attunement: "Yes",
    Rarity: "Rare",
    Effect: "You gain +1 to attack and damage rolls while wielding this " + "$Name" + ". This " + "$Name" + " instantly returns to the wielders hand after an attack is made with it, regardless of whether the attack hits or misses. If the owner does not have a hand free it instead falls to the ground at his/her feat.",
    "Cost (gp)": 7000,
    Test: /thrown/
  },
  {
    "Item": "Nine Lives Stealer $Name",
    "Type": "Weapon ($Name)",
    "Cost (gp)": "20000",
    "Rarity": "Very Rare",
    "Attunement": "Yes",
  ...
  },
  {
    ...
    "Cost (gp)": "1000000",
    "Rarity": "Legendary",
    "Attunement": "Yes (Paladin)",
    "Effect": "You gain a +3 bonus to attack and damage rolls made with this magic $Name. When you hit a fiend or an undead with it, that creature takes an extra 2d10 radiant damage.\n\nWhile you hold the drawn $Name, it creates an aura in a 10-foot radius around you. You and all creatures friendly to you in the aura have advantage on saving throws against spells and other magical effects. If you have 17 or more levels in the paladin class, the radius of the aura increases to 30 feet."
  },
  {
    "Item": "Luck $Name",
    "Type": "Weapon ($Name)",
