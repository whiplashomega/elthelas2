        ...
        <b-tabs id="refdiv">
          <b-tab title="Spells">
            ...
            <b-table show-empty
              ...
              <template slot="title" slot-scope="row"><a href="#" @click.stop="info(row.item, row.index, $event.target)">{{row.value}}</a></template>
            </b-table>
            <b-modal id="spellmodal" size="lg" @hide="resetSpellModal" :title="spelltable.modalInfo.title" ok-only>
                <h4>
              ...
              <b-tab index='2' title="Bludgeoning">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr><td>6-11</td><th>Multiple Injuries</th><td>Roll again on this table 1d3+1 times, suffering the combined effects of the various results (within reason!). Reroll any duplicates, and also reroll Multiple Injuries, Minor Scar, Full Recovery, "I'm... I'm Alright!" and any results which indicate death (like Fatal Wound or Instant Death).</td></tr>
                    <tr><td>12-13</td><th>I Can't Move!</th><td>Brain trauma leaves you fully paralysed, at least for a short time. You can do little more than speak, but can still cast spells that don't require somatic components. However, as you can't feel much of your body, you gain advantage on any Constitution saving throw to maintain concentration on spells due to receiving damage. After every long rest, the character can make a DC 14 Constitution saving throw to end the paralysis. This flaw can also be removed by magic such as Freedom of Movement, Greater Restoration, Lesser Restoration, Remove Curse or Wish.</td></tr>
                    <tr><td>14-15</td><th>I Can't See!</th><td> If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then one too many blows to the head has damaged your brain in a strange and horrible way. You are temporarily blinded. This flaw ends when you receive magic such as Lesser Restoration, Greater Restoration, Heal, Regenerate or Wish, or you succeed at a DC 14 Constitution saving throw, which you can make after every long rest.</td></tr>
                    ...
                    <tr><td>44-47</td><th>Deafened</th><td>If you wear a helmet, you must make a DC 14 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, you are deafened. This flaw is removed if you receive magic such as Greater Restoration, Heal, Lesser Restoration, Regenerate or Wish.</td></tr>
              ...
              <b-tab index="10" title="Psychic">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr><td>8-10</td><th>Horrors in the Dark</th><td>Your scrambled brain plays tricks on you, leaving your vision a deep blackness peopled by fleeting spirits and phantasms. You are temporarily blinded. This flaw ends when you receive magic such as Dream, Greater Restoration, Lesser Restoration, Remove Curse or Wish, or you succeed on a DC 14 Intelligence saving throw, which you can make after every long rest.</td></tr>
                    ...
                    <tr><td>34-38</td><th>Partially Deafened</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, the attack leaves your hearing permanently muffled. You suffer disadvantage on Wisdom (Perception) checks that rely on hearing. This flaw can be reversed through magic such as Greater Restoration, Heal, Lesser Restoration, Regenerate or Wish.</td></tr>
              ...
              <b-tab index="12" title="Slashing">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr><td>12-15</td><th>I Can't Move!</th><td>Brain trauma leaves you fully paralysed, at least for a short time. You can do little more than speak, but can still cast spells that don't require somatic components. However, as you can't feel much of your body, you gain advantage on any Constitution saving throw to maintain concentration on spells due to receiving damage. After every long rest, the character can make a DC 17 Constitution saving throw to end the paralysis. This flaw can also be ended by magic such as Freedom of Movement, Greater Restoration, Lesser Restoration, Remove Curse or Wish.</td></tr>
                    <tr><td>16-19</td><th>Frail</th><td>You recover, but your health is never quite the same again. You can barely keep food down, and lose 1 point from your Constitution score. Finally, if you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce the character's hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish.</td></tr>
                    <tr><td>20-23</td><th>Painful Joints</th><td>You heal, but are never again as sprightly. You lose 1 point from your Dexterity score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish.</td></tr>
                    <tr><td>24-27</td><th>Enfeebled</th><td>You heal, but are never again as strong. You lose 1 point from your Strength score. If you suffer this flaw again in the future, your hit dice are permanently reduced by one: if multiple versions of this flaw reduce your hit dice to 0, you die. This flaw can be removed by Greater Restoration or Wish.</td></tr>
              ...
              <b-tab index="13" title="Thunder">
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr><td>51-57</td><th>Partially Deafened</th><td>If you wear a helmet, you must make a DC 11 Constitution saving throw – if you fail (or have no helmet), then either through brain damage or damage to the ears, the attack leaves your hearing permanently muffled. You suffer disadvantage on Wisdom (Perception) checks that rely on hearing. This flaw can be removed through magic such as Greater Restoration, Heal, Lesser Restoration, Regenerate or Wish.</td></tr>
                    <tr><td>58-62</td><th>Shell-Shock</th><td>Either due to brain damage or a lifetime of facing horrors and death, you are somewhat indecisive and slow to react. You suffer a penalty of -2 to your Initiative. This flaw can be removed through magic such as Greater Restoration or Wish.</td></tr>
            ...
            <table class="table table-striped datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>if your mount is moved against it's will or you are knocked prone, you must succeed on a DC 10 Dexterity saving throw or fall off the mount, landing prone in a
                  space within 5 feet of it.  If your mount is knocked prone you may use your reaction to land on your feet next to it, otherwise you are knocked prone.</td>
                </tr>
              </tbody>
            </table>
            ...
            <table class="table table-striped datatable">
              ...
              <tbody>
                ...
                <tr>
                  <td>Use an Object</td>
                  <td>
                    Most objects can be interacted with as part of another action(such as drawing a sword or spell component).
                    Interact with one normal object for free each turn.  Certain objects require an action to use, or you can interact with a
                    second object on your turn as an action.
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table class="table table-striped datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Unarmed strikes are not weapons in the normal sense, and attacking with them does not count as a weapon attack but can be done instead of attacking with a weapon.
                    However you are always proficient in unarmed strikes.
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    When you attack with a light melee weapon held in one hand you can use a bonus action to attack with a different light melee weapon in the other hand.
                    Do not add your ability modifier to the damage of the second attack.s
                  </td>
                </tr>
                <tr>
                  <td>Grapple</td>
                  <td>
                    Replaces 1 attack.  Use strength(athletics), opposed by strength(athletics) or dexterity(acrobatics).  Target gets grappled condition(speed 0).
                    Can move grappled creature with you but speed is halved.  Target must be no more than 1 size larger than you.
                  </td>
                </tr>
                <tr>
                  <td>Shove</td>
          ...
          <b-tab index='5' title="Animals">
            ...
            <table class="table table-striped datatable">
              ...
              <tbody>
                ...
                <tr>
                  <td>Wild Beast</td><td>Livestock</td><td>((CR + 1)^2) * 250 gp</td><td>Varies</td><td>Varies</td><td>A captured wild beasts cost is based on the difficulty in capturing and taming it.</td>
                </tr>
              </tbody>
            </table>
...
<style src="./quick.scss" lang="scss" scoped></style>
