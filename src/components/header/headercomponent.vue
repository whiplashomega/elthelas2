          ...
          <div class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li class="dropdown-item" v-if="loggedin && (userinfo.username === 'whiplashomega' || userinfo.username === 'Failbot7000')"><router-link to="/tools/book4/dm/curestan">Epic of Elthelas Book 4</router-link></li>
