...
A storm cloud appears in the shape of a cylinder that is 2m tall with a 12m radius, centered on a point you can see 20m directly above you. The spell fails if you can’t see a point in the air where the storm cloud could appear (for example, if you are in a room that can’t accommodate the cloud).
